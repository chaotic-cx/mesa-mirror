...
loader_fourcc_to_image_format(int fourcc)
{
   ...
   case DRM_FORMAT_XRGB8888: return __DRI_IMAGE_FORMAT_B8G8R8X8;
   case DRM_FORMAT_ARGB8888: return __DRI_IMAGE_FORMAT_B8G8R8A8;
   case DRM_FORMAT_ABGR8888: return __DRI_IMAGE_FORMAT_R8G8B8A8;
   case DRM_FORMAT_XBGR8888: return __DRI_IMAGE_FORMAT_R8G8B8X8;
...
loader_image_format_to_fourcc(int format)
{
   ...
   case __DRI_IMAGE_FORMAT_B8G8R8X8: return DRM_FORMAT_XRGB8888;
   case __DRI_IMAGE_FORMAT_B8G8R8A8: return DRM_FORMAT_ARGB8888;
   case __DRI_IMAGE_FORMAT_R8G8B8A8: return DRM_FORMAT_ABGR8888;
   case __DRI_IMAGE_FORMAT_R8G8B8X8: return DRM_FORMAT_XBGR8888;
